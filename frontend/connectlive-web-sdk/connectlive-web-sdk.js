var ConnectLive = function() {
            ...
            return t(this, void 0, void 0, (function*() {
                try {
                    ...
                    const t = e,
                        i = t.message;
                    P.error(i);
                    throw new V(1904, "HTTP 세션에 오류가 발생했습니다.", t)
                }
            }))
        }
    }
    class U extends N {
        ...
        internally(e, i) {
            return t(this, void 0, void 0, (function*() {
                ...
                if (!t || !s || !a) throw new V(1103, "인증을 위한 서비스 정보가 입력되지 않았습니다.");
                const d = "internal",
                    c = "Provision",
                    l = {
                        scheme: d,
        ...
        externally(e, i) {
            return t(this, void 0, void 0, (function*() {
                ...
                if (!r || !t) throw new V(1103, "인증을 위한 서비스 정보가 입력되지 않았습니다.");
                const o = {
                        serviceId: r,
                        scheme: "external",
                        fingerprint: i,
    ...
    class G {
        ...
        create(e) {
            return new Promise(((t, i) => {
                ...
                try {
                    ...
                    i(new V(1401, "PeerConnection 생성이 실패했습니다.", e))
                }
                try {
                    this.createDataChannel()
                } catch (e) {
                    i(new V(1402, "데이터 채널 생성이 실패했습니다.", e))
                }
            }))
        }
        destroy() {
        ...
        createPeerConnection(e) {
            ...
            this.config.cpuOveruseDetection ? (r.optional.push({
                ...
                P.debug(`[${this.direction}] onconnectionstatechange = ${e.target.connectionState}`), this._restartIceTimerStop(), "disconnected" === e.target.connectionState ? this._restartIceTimerStart() : "failed" === e.target.connectionState && (P.error(`[${this.direction}] onconnectionstatechange = ${e.target.connectionState}`), this.emitter.emit("error", new V(1411, "PeerConnection 연결 상태가 failed 입니다.")))
            })), this.peerConnection.oniceconnectionstatechange = e => {
                P.debug(`[${this.direction}] oniceconnectionstatechange = ${e.target.iceConnectionState}`), "Firefox" === H.name && (this._restartIceTimerStop(), "disconnected" === e.target.iceConnectionState ? this._restartIceTimerStart() : "failed" === e.target.iceConnectionState && (P.error(`[${this.direction}] onconnectionstatechange = ${e.target.iceConnectionState}`), this.emitter.emit("error", new V(1411, "PeerConnection 연결 상태가 failed 입니다."))))
    ...
    class X extends Z {
        ...
        setQuality(e) {
            return t(this, void 0, void 0, (function*() {
                if ("l" !== e && "m" !== e && "h" !== e) throw new V(1207, "비디오 품질 변경 인자는 'l', 'm', ''h 중 하나여야 합니다.");
            ...
            return t(this, void 0, void 0, (function*() {
                if (this.constraints && this.constraints.video) {
                    ...
                    try {
                        ...
                        const t = e,
                            i = t.message;
                        throw P.error("Failed to switchCamera. ", t.name, i), new V(1203, `getUserMedia 실패(${i})`, t)
                    }
                    const [i] = t.getVideoTracks();
                    if (i) {
                        if ("ended" === i.readyState) throw new V(1206, "비디오 트랙을 획득했지만 종료 상태입니다.");
            ...
            return t(this, void 0, void 0, (function*() {
                if (this.constraints && this.constraints.audio) {
                    ...
                    try {
                        ...
                        const t = e,
                            i = t.message;
                        throw P.error("Failed to switchMic. ", t.name, i), new V(1203, `getUserMedia 실패(${i})`, t)
                    }
                    const [i] = t.getAudioTracks();
                    if (i) {
                        if ("ended" === i.readyState) throw new V(1205, "오디오 트랙을 획득했지만 종료 상태입니다.");
        ...
        _getUserMedia() {
            return t(this, void 0, void 0, (function*() {
                ...
                try {
                    ...
                    if (P.debug("got mediaStream", "id=" + e.id, "active=" + e.active), t && (P.debug("got audio track", "id=" + t.id, "label=" + t.label, "enabled=" + t.enabled, "kind=" + t.kind, "muted=" + t.muted, "readyState=" + t.readyState), "ended" === t.readyState)) throw new V(1205, "오디오 트랙을 획득했지만 종료 상태입니다.");
                    if (i && (P.debug("got video track", "id=" + i.id, "label=" + i.label, "enabled=" + i.enabled, "kind=" + i.kind, "muted=" + i.muted, "readyState=" + i.readyState), "ended" === i.readyState)) throw new V(1206, "비디오 트랙을 획득했지만 종료 상태입니다.");
                    this.audio = t ? new oe(t, "single") : void 0, this.video = i ? new re(i, "multiple") : void 0
                } catch (e) {
                    const t = e,
                        i = t.message;
                    throw P.error("Failed to getUserMedia. ", t.name, i), new V(1203, `getUserMedia 실패(${i})`, t)
                }
            }))
        }
        stop() {
        ...
        _getDisplayMedia() {
            ...
            return t(this, void 0, void 0, (function*() {
                ...
                try {
                    ...
                    if (this.audio = i ? new oe(i, "single") : void 0, this.video = r ? new re(r, "single") : void 0, P.debug("got display stream", "id=" + t.id, "active=" + t.active), i && (P.debug("got display audio track", "id=" + i.id, "label=" + i.label, "enabled=" + i.enabled, "kind=" + i.kind, "muted=" + i.muted, "readyState=" + i.readyState), "ended" === i.readyState)) throw new V(1205, "오디오 트랙을 획득했지만 종료 상태입니다.");
                    if (r && (P.debug("got display video track", "id=" + r.id, "label=" + r.label, "enabled=" + r.enabled, "kind=" + r.kind, "muted=" + r.muted, "readyState=" + r.readyState), "ended" === r.readyState)) throw new V(1205, "비디오 트랙을 획득했지만 종료 상태입니다.");
                    ...
                    const t = e,
                        i = t.message;
                    throw P.error("Failed to getDisplayMedia. ", t.name, i), new V(1204, `getDisplayMedia 실패(${i})`, t)
                }
            }))
        }
        stop() {
    ...
    class pe extends $ {
        ...
        connect(e) {
            return t(this, void 0, void 0, (function*() {
                if (!/^[a-zA-Z0-9-]+$/.test(e) || e.length > 32) throw new V(1301, "입력한 룸 id가 지원하지 않는 길이, 문자를 포함합니다.(32자 이하, 영문자/숫자/- 만 가능)");
        ...
        publish(e, i = !1) {
            return t(this, void 0, void 0, (function*() {
                if (e.length < 1) throw new V(1324, "빈 배열이 전달되었습니다.");
                const r = e => {
                        let r, o;
        ...
        subscribe(e) {
            return new Promise(((t, i) => {
                ...
                if (o.length) return i(new V(1321, "이미 구독 중인 스트림입니다. " + o));
        ...
        _setReceiverPool(e) {
            return t(this, void 0, void 0, (function*() {
                if (this._checkMaxReceiverCount()) throw new V(1322, "리시버 갯수는 maxReceiverCount를 초과할 수 없습니다.");
                var t, i;
        ...
        _assignVideoStream(e) {
            return t(this, void 0, void 0, (function*() {
                if (0 === e.length) throw new V(1323, "빈 streamIds이 전달되었습니다.");
                if (this._checkMaxReceiverCount()) throw new V(1322, "리시버 갯수는 maxReceiverCount를 초과할 수 없습니다.");
                const i = this._checkAlreadySubscribe(e);
                if (i.length) throw new V(1321, "이미 구독 중인 스트림입니다. " + i);
    ...
    class me {
        constructor() {
            new V(1901, "ConnectLive로 부턱 직접 객체를 선언할 수 없습니다.")
        }
        static on(e, t) {
            this.emitter.on(e, t)
        }
        ...
        static createRoom(e) {
            ...
            throw new V(1106, "룸 생성 전 인증이 필요합니다.")
        }
    }
